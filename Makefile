...
CFLAGS   = -I.              -O4 -mno-f16c -mno-avx2 -mno-avx -ffast-math -DNDEBUG -std=c11   -fPIC
CXXFLAGS = -I. -I./examples -O4 -mno-f16c -mno-avx2 -mno-avx -ffast-math  -DNDEBUG -std=c++11 -fPIC
LDFLAGS  =
